...
_Auto-generated by Harbor Task Checker_"
    ...
    SUBMIT_URL="https://github.com/abundant-ai/task-bank/issues/new?template=task-submission.yml&title=$ENCODED_TITLE&body=$ENCODED_BODY&labels=task-submission"
